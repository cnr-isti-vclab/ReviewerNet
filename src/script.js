...
<<<<<<< HEAD
            init_txt = "<br><br>ReviewerNet helps journal editors and programme committee members selecting reviewers by maximizing the reviewer expertise and minimizing the conflict of interest.<br><br> ReviewerNet builds on a reference database including papers, authors and citations from the <a target=\"_blank\"class=\"links\" href=\"https://www.semanticscholar.org/\">Semantic Scholar</a> Research Corpus.<br>The main idea is using visual representations of citation and co-authorship relations, under the assumption that the authors of relevant papers are good candidate reviewers.<br><br>Click to start a platform demonstration in the field of Computer Graphics. The reference dataset contains "+papers.length+" papers, "+citations.length+" citations, and "+authors.length+" authors from eight sources<br>(ACM Transactions on Graphics, Computer Graphics and Applications, Computer Graphics Forum, Computers & Graphics, IEEE Transactions on Visualization and Computer Graphics, Visual Computer, Proceedings of IEEE Conference Visualization pre 2006, Proceedings of ACM SIGGRAPH pre 2003), spanning the years in-between 1995 and 2018.<br><br> ReviewerNet can be built over any dataset, according to the domain of interest.<br><br><center>We use technical, statistical and third parties-cookies to improve ReviewerNet experience.<br>We DO NOT use profiling and advertising cookies.<br>We reserve the right of tracking your usage of ReviewerNet for collecting statistical information in aggregate anonymous way.<br>Click anywhere to acknowledge this info and start using ReviewerNet.</center><br><a>(Learn more about cookies)</a>" 
=======
            init_txt = "<br><br><b>ReviewerNet</b> is a tool for reviewers by maximizing expertise coverage and minimizing the conflicts.<br>The main idea is using visual representations of citation and co-authorship, assuming authors of relevant papers are good candidate reviewers.<br><br>Click to start a platform demonstration in the field of Computer Graphics.<br> <br> ReviewerNet builds on a reference database including papers, authors and citations from the <a target=\"_blank\"class=\"links\" href=\"https://www.semanticscholar.org/\">Semantic Scholar</a> Research Corpus.<br> The reference dataset contains "+papers.length+" papers, "+citations.length+" citations, and "+authors.length+" authors, from 1995 to 2018, from eight sources:<br>ACM Transactions on Graphics,<br>Computer Graphics Forum,<br>IEEE Trans. on Visualization and Computer Graphics,<br> The Visual Computer,<br>IEEE Computer Graphics and Applications,<br> Computers & Graphics,<br> Proc. of IEEE Conf. on Visualization (pre 2006),<br> Proc. of ACM SIGGRAPH (pre 2003).<br><br> ReviewerNet can be built over any dataset, according to the domain of interest." 
>>>>>>> 1c6e3497f2716038abb2770a14cd505cdb5ee0ae
